...
import (
	...
	"exercise3/utils/crack"
)

func main() {
    wordlist := flag.String("wordlist", "nord_vpn.txt", "path to wordlist file")
    target := flag.String("hash", "485f5c36c6f8474f53a3b0e361369ee3e32ee0de2f368b87b847dd23cb284b316bb0f026ada27df76c31ae8fa8696708d14b4d8fa352dbd8a31991b90ca5dd38", "target SHA512 hash to crack")
